...
It is distributed under GNU GPLv.3, Commercial (JavaPlanner Standard) and Enterprise(JavaPlanner Pro) licenses. 
...
- DHTMLX Scheduler in ASP.NET
	http://scheduler-net.com/
- Javascript dhtmlxScheduler
